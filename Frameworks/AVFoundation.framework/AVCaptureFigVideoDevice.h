...
@class AVCaptureDeviceFormat, AVWeakReference, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
...
+ (void)initialize;
+ (id)alloc;
- (void)_callClientOnMainThreadWithDeviceControlCompletionHandler:(id)arg1 syncTime:(void)arg2;
...
- (int)_setWhiteBalanceWithMode:(long long)arg1 gains:(CDStruct_d6531dd4)arg2;
- (void)setWhiteBalanceModeLockedWithDeviceWhiteBalanceGains:(CDStruct_d6531dd4)arg1 completionHandler:(id)arg2;
...
- (void)setExposureModeCustomWithDuration:(CDStruct_1b6d18a9)arg1 ISO:(float)arg2 completionHandler:(id)arg3;
- (float)ISO;
- (float)ISODigitalThreshold;
- (CDStruct_1b6d18a9)exposureDuration;
- (void)setExposureMode:(long long)arg1;
- (long long)exposureMode;
- (int)_setExposureWithMode:(long long)arg1 duration:(CDStruct_1b6d18a9)arg2 ISO:(float)arg3;
