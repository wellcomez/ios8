...
@class AVAudioOnlyIndicatorView, AVContentOverlayView, AVExternalPlaybackIndicatorView, AVFullScreenViewController, AVLoadingIndicatorView, AVNowPlayingInfoController, AVPlaybackControlsViewController, AVPlayer, AVPlayerController, AVRemoteCommandController, AVTouchIgnoringView, AVUnsupportedContentIndicatorView, AVVideoLayerView, CALayer<AVVideoLayer>, NSString, NSTimer, UIPopoverController, UIView, UIWindow;
