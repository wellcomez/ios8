...
@class ABMembersDataSource, ABMembersFilteredDataSource, NSIndexPath, NSOperationQueue, NSString, UISearchController, UITableView, UITableViewController, UIViewController, _UINavigationControllerPalette;
...
@property(readonly) UITableViewController *searchResultsController; // @synthesize searchResultsController=_searchResultsController;
