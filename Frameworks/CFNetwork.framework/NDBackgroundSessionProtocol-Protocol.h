...
- (void)avAssetDownloadTaskWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 identifier:(unsigned long long)arg4 reply:(id)arg5;
- (void)invalidateWithReply:(id)arg1;
...
- (void)dataTaskWithRequest:(id)arg1 originalRequest:(id)arg2 identifier:(unsigned long long)arg3 reply:(id)arg4;
...
- (void)downloadTaskWithRequest:(id)arg1 originalRequest:(id)arg2 downloadFilePath:(id)arg3 identifier:(unsigned long long)arg4 reply:(id)arg5;
@end
