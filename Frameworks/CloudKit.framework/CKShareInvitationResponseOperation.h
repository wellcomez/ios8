...
@property(copy, nonatomic) id shareInvitationResponseCompletionBlock; // @synthesize shareInvitationResponseCompletionBlock=_shareInvitationResponseCompletionBlock;
