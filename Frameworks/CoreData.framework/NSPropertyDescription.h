...
@interface NSPropertyDescription : NSObject <NSCoding, NSCopying>
{
    ...
    _Bool _indexedBySpotlight;
    _Bool _storedInExternalRecord;
}

+ (void)initialize;
@property(getter=isStoredInExternalRecord) _Bool storedInExternalRecord; // @synthesize storedInExternalRecord=_storedInExternalRecord;
@property(getter=isIndexedBySpotlight) _Bool indexedBySpotlight; // @synthesize indexedBySpotlight=_indexedBySpotlight;
