...
- (id)_executeSaveRequest:(id)arg1 forceInsertsToUpdates:(_Bool)arg2 withContext:(id)arg3 interrupts:(unsigned long long *)arg4 error:(id *)arg5;
- (void)_commitChangesForRequest:(id)arg1;
- (id)encodeSaveRequest:(id)arg1 forceInsertsToUpdates:(_Bool)arg2;
- (id)encodeObjectsForSave:(id)arg1 forDelete:(_Bool)arg2;
