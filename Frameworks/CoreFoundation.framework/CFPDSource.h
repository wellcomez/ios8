...
+ (void)withSourceForDomain:(struct __CFString *)arg1 forRemoteClient:(id)arg2 inContainer:(struct __CFString *)arg3 user:(struct __CFString *)arg4 byHost:(_Bool)arg5 managed:(_Bool)arg6 perform:(id)arg7;
...
- (_Bool)acceptLocalMessage:(struct __CFDictionary *)arg1 withReply:(struct __CFDictionary *)arg2;
