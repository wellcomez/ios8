...
@class EKDayAllDayView, EKDayTimeView, EKDayViewContent, EKEvent, NSArray, NSCalendar, NSDate, NSDateComponents, NSTimer, UIColor, UIImageView, UIPinchGestureRecognizer, UIScrollAnimation, UIScrollView, UITapGestureRecognizer;
...
- (double)pinchDistanceForGestureRecognizer:(id)arg1;
