...
@class EKCalendarItem, EKEventStore, EKStructuredLocation, EKTravelRouteEstimationController, NSDate, NSIndexPath, UISwitch, UITableView;
...
- (long long)_numberOfEstimationGroupRows;
