...
@class GEOAddress, GEOMapRegion, GEOPDFlyover, GEOPlace, MKMapItemMetadata, MKPlacemark, NSArray, NSData, NSString, NSURL;
...
@property(readonly, nonatomic, getter=_showMoreReviews) _Bool showMoreReviews;
...
@property(readonly, nonatomic, getter=_boundingRect) CDStruct_90e2a262 boundingRect;
@property(readonly, nonatomic, getter=_boundingRegion) GEOMapRegion *boundingRegion;
