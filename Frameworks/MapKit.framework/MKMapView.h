...
- (void)_prepareFlyoverAnimation:(id)arg1 inBackground:(_Bool)arg2 completion:(id)arg3;
- (void)setVisibleMapRect:(CDStruct_90e2a262)arg1 animated:(_Bool)arg2;
@property(nonatomic) CDStruct_90e2a262 visibleMapRect;
- (void)_setVisibleMapRect:(CDStruct_90e2a262)arg1 duration:(double)arg2 completionHandler:(id)arg3;
- (void)_setVisibleMapRect:(CDStruct_90e2a262)arg1 animated:(_Bool)arg2 completionHandler:(id)arg3;
...
- (void)_goToMapRegion:(id)arg1 duration:(double)arg2 animationType:(int)arg3 resetHeading:(_Bool)arg4 completionHandler:(id)arg5;
