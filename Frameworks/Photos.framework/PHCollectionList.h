...
+ (id)fetchMomentListsWithType:(long long)arg1 options:(id)arg2;
+ (id)fetchMomentListsWithType:(long long)arg1 containingMoment:(id)arg2 options:(id)arg3;
+ (id)fetchRootAlbumCollectionListWithOptions:(id)arg1;
+ (id)fetchCollectionListsWithCollectionListType:(long long)arg1 options:(id)arg2;
...
@property(readonly, copy, nonatomic) id childCollectionsSortingComparator; // @synthesize childCollectionsSortingComparator=_childCollectionsSortingComparator;
