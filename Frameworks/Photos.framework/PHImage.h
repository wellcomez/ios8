...
+ (id)imageWithBLPromiseImage:(id)arg1 format:(int)arg2 isPlaceholder:(_Bool)arg3;
...
@property(readonly, nonatomic) BLPromiseImage *promiseImage; // @synthesize promiseImage=_promiseImage;
...
- (void).cxx_destruct;
- (id)initWithBLPromiseImage:(id)arg1 format:(int)arg2 isPlaceholder:(_Bool)arg3;
