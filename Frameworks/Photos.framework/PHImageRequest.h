...
+ (id)imageRequestWithAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 domain:(id)arg5 resultHandler:(id)arg6;
...
- (id)initImageRequestWithAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 domain:(id)arg5 resultHandler:(id)arg6;
- (id)description;
