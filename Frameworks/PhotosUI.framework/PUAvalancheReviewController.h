...
@class NSIndexPath, NSMutableDictionary, NSMutableSet, NSOrderedSet, PHCachingImageManager, PHFetchResult, PLAvalanche, PLManagedAsset, PUAvalancheReviewCollectionViewLayout, PUAvalancheReviewControllerSpec, PUImageManager, PUPhotoBrowserController, PUPhotoPinchGestureRecognizer, PUPhotosSharingTransitionContext, PUPhotosZoomingSharingGridCell, PUReviewInstructionalView, PUReviewScrubber, PUTransitionViewAnimator, UIBarButtonItem, UICollectionView, UICollectionViewLayout, UITapGestureRecognizer;
...
- (void)_promoteFavoriteAssetsAndDeleteNonPicks:(_Bool)arg1 withReviewCompletionHandler:(id)arg2;
