...
#import "PUCropAndStraightenViewDelegate-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class CIImage, NSDictionary, NSMutableDictionary, NSTimer, PLPhotoEditModel, PLPhotoEditRenderer, PUCropAndStraightenView, PUCropOverlayView, PUCropToolControllerSpec, PUTiltWheelControl, UIButton, UIImage, UIView;
...
@interface PUCropToolController : PUPhotoEditToolController <UIGestureRecognizerDelegate, PUCropAndStraightenViewDelegate>
{
    ...
    struct CGRect __initialDoubleTapCropRect;
...
@property(nonatomic, setter=_setAspectRatio:) double _aspectRatio; // @synthesize _aspectRatio=__aspectRatio;
...
@property(nonatomic, setter=_setInitialDoubleTapCropRect:) struct CGRect _initialDoubleTapCropRect; // @synthesize _initialDoubleTapCropRect=__initialDoubleTapCropRect;
...
@property(retain, nonatomic, setter=_setFadeOutTimer:) NSTimer *_fadeOutTimer; // @synthesize _fadeOutTimer=__fadeOutTimer;
...
- (void)_setContentViewsHidden:(_Bool)arg1 animated:(_Bool)arg2 completion:(id)arg3;
...
- (_Bool)_isResettingValues;
- (_Bool)_hasAllIdentityValues;
...
- (id)_animateValueFromValue:(double)arg1 toValue:(double)arg2 interpolation:(id)arg3 completion:(void)arg4;
...
- (void)_setAspectRatio:(double)arg1 animated:(_Bool)arg2;
- (void)_setRotation:(unsigned long long)arg1 animated:(_Bool)arg2;
- (struct CGRect)_viewCropToMatchPreview;
- (struct CGRect)_rectThatFillsFrame:(struct CGRect)arg1 withImageRegion:(struct CGRect)arg2;
- (unsigned long long)rotationAfterRotation:(unsigned long long)arg1;
