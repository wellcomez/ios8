...
- (void)_requestThumbnailsWithFilters:(id)arg1 size:(struct CGSize)arg2 singleCompletion:(id)arg3 fullCompletion:(void)arg4;
- (void)requestThumbnailsWithFilters:(id)arg1 size:(struct CGSize)arg2 singleCompletion:(id)arg3;
- (void)requestThumbnailsWithFilters:(id)arg1 size:(struct CGSize)arg2 fullCompletion:(id)arg3;
