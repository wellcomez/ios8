...
#import "PLPhotoBrowserControllerInitDataSource-Protocol.h"
...
@class NSIndexPath, NSMutableArray, NSMutableDictionary, NSPredicate, PHCachingImageManager, PHChange, PHFetchResult, PLDeletePhotosActionController, PUActivityViewController, PUAlbumListTransitionContext, PUAlbumPickerViewController, PUPhotoBrowserController, PUPhotoPinchGestureRecognizer, PUPhotoSelectionManager, PUPhotosGridViewControllerSpec, PUPhotosSinglePickerViewController, PUPopoverController, PUSearchButtonItem, PUSearchViewController, PUSessionInfo, UIActionSheet, UIBarButtonItem, UICollectionViewLayout, UICollectionViewLayout<PUGridLayoutProtocol>, UILongPressGestureRecognizer, UINavigationButton, UIView;
...
- (void)configureGridCell:(id)arg1 forItemAtIndexPath:(id)arg2 ignorePlaceholder:(_Bool)arg3;
...
- (id)_assetsAllowingEditOperation:(unsigned long long)arg1 fromAssets:(id)arg2;
...
- (_Bool)_canAllContainersPerformEditOperation:(unsigned long long)arg1;
