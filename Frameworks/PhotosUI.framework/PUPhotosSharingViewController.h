...
@class NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSPredicate, PHAsset, PHCachingImageManager, PHFetchResult, PUActivityViewController, PUPhotoPinchGestureRecognizer, PUPhotoSelectionManager, PUPhotosSharingCollectionViewLayout, PUPhotosSharingTransitionContext, PUPhotosSharingViewControllerSpec, PUPhotosZoomingSharingGridCell, PUScrollViewSpeedometer, PUTransitionViewAnimator, UIBarButtonItem, UICollectionView, UICollectionViewLayout, UITapGestureRecognizer, UIView;
...
@property(copy, nonatomic, setter=_pptSetOnDidEndScrollingBlock:) id _pptOnDidEndScrollingBlock; // @synthesize _pptOnDidEndScrollingBlock=__pptOnDidEndScrollingBlock;
...
- (_Bool)activityViewControllerShouldCancelAfterRemakingCanceled:(id)arg1;
...
- (_Bool)ppt_scrollToAssetAtRelativeIndex:(long long)arg1 completion:(id)arg2;
