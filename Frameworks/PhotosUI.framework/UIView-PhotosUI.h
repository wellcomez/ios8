...
+ (void)pu_animateWithEnforcedDuration:(double)arg1 animations:(id)arg2 completion:(void)arg3;
+ (void)_pu_animateWithDuration:(double)arg1 enforced:(_Bool)arg2 animations:(id)arg3 completion:(void)arg4;
