...
@class EAGLContext, NSLock, NSObject<OS_dispatch_queue>, SCNNode, SCNScene, SCNTechnique, SKScene, UIColor, __SKSCNRenderer;
...
- (_Bool)_preloadResource:(id)arg1 abortHandler:(id)arg2;
