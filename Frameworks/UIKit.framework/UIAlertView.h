...
@class NSMutableArray, NSMutableDictionary, NSString, UIAlertController, UILabel, UIToolbar, UIViewController, UIWindow, _UIAlertExternalViewController, _UIModalItem;
...
@property(readonly, retain, getter=_alertController) UIAlertController *alertController;
