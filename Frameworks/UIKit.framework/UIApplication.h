...
#import "FBSUIApplicationSystemServiceDelegate-Protocol.h"
#import "FBSUIApplicationWorkspaceDelegate-Protocol.h"
...
- (void)_handleApplicationDectivationWithScene:(id)arg1 shouldForceExit:(_Bool)arg2 transitionContext:(id)arg3 completion:(id)arg4;
...
- (void)finishedTest:(id)arg1 waitForCommit:(_Bool)arg2 extraResults:(id)arg3 withTeardownBlock:(id)arg4;
...
- (void)runTestForKeyboardSplitAndMergeWithName:(id)arg1 withShowKeyboardBlock:(id)arg2 withExtraResultsBlock:(void)arg3 withCleanupBlock:(id)arg4;
- (void)runTestForKeyboardRotationWithName:(id)arg1 fromOrientation:(long long)arg2 withShowKeyboardBlock:(id)arg3 withExtraResultsBlock:(void)arg4 withCleanupBlock:(id)arg5;
- (void)runTestForKeyboardBringupAndDismissalWithName:(id)arg1 withShowKeyboardBlock:(id)arg2 withHideKeyboardBlock:(void)arg3 withExtraResultsBlock:(id)arg4 withCleanupBlock:(void)arg5;
- (void)_runSubTestForKeyboardMergeWithName:(id)arg1 withExtraResultsBlock:(id)arg2 withCleanupBlock:(void)arg3;
- (void)_runSubTestForKeyboardSplitWithName:(id)arg1 withShowKeyboardBlock:(id)arg2 withExtraResultsBlock:(void)arg3 withCleanupBlock:(id)arg4;
- (void)_runSubTestForKeyboardDismissalWithName:(id)arg1 withHideKeyboardBlock:(id)arg2 withExtraResultsBlock:(void)arg3 withCleanupBlock:(id)arg4;
- (void)_runSubTestForKeyboardBringupWithName:(id)arg1 withShowKeyboardBlock:(id)arg2 withHideKeyboardBlock:(void)arg3 withExtraResultsBlock:(id)arg4 withCleanupBlock:(void)arg5;
- (void)showKeyboardUsingBlock:(id)arg1 withCompletionBlock:(void)arg2;
