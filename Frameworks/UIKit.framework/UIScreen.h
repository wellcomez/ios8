...
@class FBSDisplay, NSArray, NSDictionary, NSMutableArray, UIScreenMode, UISoftwareDimmingWindow, UITraitCollection, UIWindow, _UIScreenTransparentHitTestWindow;
