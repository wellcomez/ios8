...
#import "UIViewControllerPresenting-Protocol.h"
...
- (void)_enumerateAncestorViewControllersUntilStop:(_Bool *)arg1 usingBlock:(id)arg2;
...
@property(readonly, retain, nonatomic) _UILayoutGuide *rightLayoutGuide; // @synthesize rightLayoutGuide=_rightLayoutGuide;
@property(readonly, retain, nonatomic) _UILayoutGuide *leftLayoutGuide; // @synthesize leftLayoutGuide=_leftLayoutGuide;
