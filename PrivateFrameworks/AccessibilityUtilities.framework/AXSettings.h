...
@class NSArray, NSDate, NSDictionary, NSMutableDictionary, NSMutableSet, NSNumber, NSObject<OS_dispatch_queue>, NSOrderedSet, NSSet, NSString;
...
@property(retain, nonatomic) NSOrderedSet *zoomPreferredLensEffects;
