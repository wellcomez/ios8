...
@class AAAutoAccountVerifier, ACAccount, ACAccountStore, DAAccount, MFAccountValidator, NSMutableArray, NSMutableDictionary;
...
- (void)setBackupEnabled:(_Bool)arg1 completion:(id)arg2;
...
- (void)setCloudServicesEnabled:(_Bool)arg1 completion:(id)arg2;
- (id)_account;
- (id)init;
