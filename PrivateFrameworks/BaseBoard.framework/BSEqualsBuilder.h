...
+ (id)builder;
- (id)appendCGRect:(struct CGRect)arg1 counterpart:(id)arg2;
- (id)appendCGSize:(struct CGSize)arg1 counterpart:(id)arg2;
- (id)appendCGPoint:(struct CGPoint)arg1 counterpart:(id)arg2;
...
- (id)appendBool:(_Bool)arg1 counterpart:(id)arg2;
