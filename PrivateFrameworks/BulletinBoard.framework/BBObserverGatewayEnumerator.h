...
- (void)dealloc;
- (void)enumerate:(id)arg1 numberOfUniqueGateways:(unsigned long long)arg2 bulletin:(id)arg3 bulletinID:(id)arg4 feeds:(unsigned long long)arg5 didPlayLightsAndSirensHandler:(id)arg6 completion:(void)arg7;
