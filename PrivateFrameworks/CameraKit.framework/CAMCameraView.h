...
#import "CAMBottomBarDelegate-Protocol.h"
#import "CAMModeDialDataSource-Protocol.h"
#import "CAMStillImageCaptureRequestDelegate-Protocol.h"
#import "CAMTimerButtonDelegate-Protocol.h"
#import "CAMTopBarDelegate-Protocol.h"
...
@class CALayer, CAMAnimationDelegate, CAMAvalancheIndicatorView, CAMBlurredSnapshotView, CAMBottomBar, CAMCameraSpec, CAMCaptureController, CAMElapsedTimeView, CAMExposureBiasTextView, CAMFilterButton, CAMFlashBadge, CAMFlashButton, CAMFlipButton, CAMGridView, CAMHDRBadge, CAMHDRButton, CAMHardwareLockIndicatorView, CAMImageWell, CAMLowDiskSpaceAlertView, CAMModeDial, CAMPanoramaView, CAMPreviewView, CAMShutterButton, CAMSlalomIndicatorView, CAMTimerButton, CAMTimerIndicatorView, CAMTopBar, CAMTorchPatternController, CAMZoomSlider, NSDate, NSMutableArray, NSMutableSet, NSObject<OS_dispatch_source>, NSTimer, PLCameraIrisAnimationView, PLCameraOverlayTextLabelView, PLPreviewOverlayView, UIAlertView, UIImageView, UILongPressGestureRecognizer, UIPanGestureRecognizer, UISwipeGestureRecognizer, UITapGestureRecognizer;
...
@property(readonly, nonatomic) _Bool _allowsStillDuringVideo;
...
- (void)_applyModeSwitchingBlurAnimated:(_Bool)arg1 withCompletionBlock:(id)arg2;
...
- (void)_snapshotView:(id)arg1 andLayoutForOrientation:(long long)arg2 leaveHidden:(_Bool)arg3 withBlock:(id)arg4;
