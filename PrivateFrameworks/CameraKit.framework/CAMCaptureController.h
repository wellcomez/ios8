...
@class AVCaptureDevice, AVCaptureDeviceFormat, AVCaptureDeviceInput, AVCaptureMetadataOutput, AVCaptureMovieFileOutput, AVCaptureOutput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, BKSAccelerometer, CAMAvalancheCaptureService, CAMDebugCaptureService, CAMEffectsRenderer, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSTimer;
...
@property(copy, nonatomic, setter=_setLockLensPositionCompletionBlock:) id _lockLensPositionCompletionBlock; // @synthesize _lockLensPositionCompletionBlock=__lockLensPositionCompletionBlock;
...
- (_Bool)_isCapturingStillDuringVideo;
...
@property(readonly, retain, nonatomic) NSArray *activeFilters;
...
- (_Bool)_configureSessionWithCameraMode:(long long)arg1 cameraDevice:(long long)arg2 HDRDetectionEnabled:(_Bool)arg3;
