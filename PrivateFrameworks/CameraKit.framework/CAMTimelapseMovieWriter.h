...
@property(readonly, copy, nonatomic) id _completion; // @synthesize _completion=__completion;
...
- (void)writeMovieFromFiles:(id)arg1 startDate:(id)arg2 outputPath:(id)arg3 transform:(struct CGAffineTransform)arg4 framesPerSecond:(long long)arg5 completionHandler:(id)arg6;
- (void)_reset;
- (id)init;
