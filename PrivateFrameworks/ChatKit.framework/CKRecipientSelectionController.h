...
@class ABPeoplePickerNavigationController, CKComposeRecipientView, CKConversation, CKRecipientSearchListController, CKScheduledUpdater, MFComposeRecipient, NSArray, NSMutableDictionary, UIScrollView, UIView;
...
@property(readonly, nonatomic) _Bool shouldUsePopovers; // @synthesize shouldUsePopovers=_shouldUsePopovers;
...
@property(retain, nonatomic) CKScheduledUpdater *toFieldUpdater; // @synthesize toFieldUpdater=_toFieldUpdater;
...
- (void)_updateToField;
- (_Bool)_canAddRecipient:(id)arg1 withError:(char *)arg2;
