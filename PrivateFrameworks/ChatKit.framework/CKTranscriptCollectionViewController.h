...
@class CKAudioController, CKConversation, CKTranscriptCollectionView, IMChat, NSArray, NSIndexSet, NSObject<OS_dispatch_group>, UITapGestureRecognizer, UIView<CKGradientReferenceView>;
...
@property(copy, nonatomic) id transcriptUpdateCompletion; // @synthesize transcriptUpdateCompletion=_transcriptUpdateCompletion;
...
- (void)updateTranscriptChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 reload:(id)arg4 regenerate:(id)arg5 animated:(_Bool)arg6 completion:(id)arg7;
...
- (void)updateTranscript:(id)arg1 animated:(void)arg2 completion:(_Bool)arg3;
- (void)reloadData;
