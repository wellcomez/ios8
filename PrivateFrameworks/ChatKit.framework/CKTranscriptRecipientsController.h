...
@class CKConversation, CKGroupRecipientSelectionController, CKTranscriptAddRecipientCell, CKTranscriptLocationShareCell, NSDictionary, NSString, NSTimer;
...
- (_Bool)_allowGroupRecipientRemoval;
- (_Bool)_shouldShowGroupUI;
