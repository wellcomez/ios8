...
@class APSConnection, BRCAccountSession, BRCContainerMetadataSyncPersistedState, BRCCountedSet, BRCMinHeap, BRCOperation, BRCRRQueue, BRCRelativePath, BRCThrottle, BRCThrottledScheduler, CKContainer, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSOperationQueue, NSString, PQLConnection;
...
- (void)resetContainer:(id)arg1 isFullReset:(_Bool)arg2;
