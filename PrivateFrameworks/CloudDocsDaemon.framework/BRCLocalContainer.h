...
@class BRCAccountSession, BRCDBThrottle, BRCOperation, BRCRelativePath, BRCServerContainer, BRCVersionDownloader, BRCVersionUploader, BRContainer, NSArray, NSDictionary, NSError, NSMutableIndexSet, NSMutableSet, NSNumber, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_source>, NSString, NSURL, PQLConnection, PQLNameInjection;
...
@property(nonatomic) unsigned long long syncUpRetryStamp; // @synthesize syncUpRetryStamp=_syncUpRetryStamp;
...
- (void)rescheduleUnappliedRank:(unsigned long long)arg1 forFaultCreation:(_Bool)arg2;
...
- (PQLResultSet_67aa68bb *)itemsEnumeratorParentedTo:(id)arg1 notParentedTo:(id)arg2 rankMin:(unsigned long long)arg3 rankMax:(unsigned long long)arg4 shouldIncludeFolders:(_Bool)arg5 shouldIncludeAliases:(_Bool)arg6 count:(unsigned long long)arg7;
