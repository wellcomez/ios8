...
@class BRCDesiredVersion, BRCItemID, BRCLocalContainer, BRCLocalStatInfo, BRCLocalVersion, NSNumber, NSString;
...
- (void)markLiveFromStageAndShouldFixup:(_Bool)arg1;
...
- (_Bool)applyMetadataOnFileID:(unsigned long long)arg1 liveFD:(unsigned long long)arg2;
