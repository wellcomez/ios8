...
@class BRCAccountSession, BRCBookmark, BRCGenerationID, BRCLocalContainer, NSDictionary, NSDirectoryEnumerator, NSNumber, NSString, NSURL;
...
@property(readonly, nonatomic) NSDictionary *faultDict;
- (void)_resolveFaultInfo;
- (_Bool)isEqualToRelativePath:(id)arg1;
- (_Bool)isEqual:(id)arg1;
- (_Bool)isSubpathOfRelativePath:(id)arg1;
- (void)closeDirectoryScan;
- (id)nextDescendant;
- (_Bool)openDirectoryForRecursiveScan;
- (id)nextChild;
- (_Bool)openDirectoryForScanWithError:(int *)arg1;
- (_Bool)performOnOpenParentFileDescriptor:(id)arg1 error:(void)arg2;
- (_Bool)performOnOpenFileDescriptor:(id)arg1 error:(void)arg2;
