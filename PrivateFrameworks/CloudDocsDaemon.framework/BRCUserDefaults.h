...
@class NSArray, NSDictionary, NSMutableDictionary, NSObject<OS_xpc_object>, NSString;
...
@property(readonly, nonatomic) _Bool allowUnencryptedBasename;
...
@property(readonly, nonatomic) _Bool forceGreedyContainer;
...
@property(readonly, nonatomic) NSDictionary *syncUpThrottleParams;
