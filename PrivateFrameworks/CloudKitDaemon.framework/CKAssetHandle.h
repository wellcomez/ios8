...
@interface CKAssetHandle : CKObject
{
    ...
    long long _removePolicy;
    NSDate *_lastUsedDate;
}

@property(retain, nonatomic) NSDate *lastUsedDate; // @synthesize lastUsedDate=_lastUsedDate;
@property(nonatomic) long long removePolicy; // @synthesize removePolicy=_removePolicy;
...
- (_Bool)shouldRemoveWhenUnreferencedAndCacheIsFull;
- (_Bool)shouldRemoveWhenUnreferenced;
- (_Bool)shouldNeverRemove;
