...
- (void).cxx_destruct;
- (_Bool)canReadMMCSItem:(id)arg1;
- (_Bool)canReadFileAtPath:(id)arg1;
...
- (void)_setApplicationPermission:(unsigned long long)arg1 enabled:(_Bool)arg2 completionHandler:(id)arg3;
...
- (_Bool)_clientHasCustomAccountsEntitlement;
- (_Bool)_clientHasEnvironmentEntitlement;
- (_Bool)_clientHasMasqueradingEntitlement;
