...
@property(nonatomic) long long deleteTimeSec; // @synthesize deleteTimeSec=_deleteTimeSec;
@property(nonatomic) long long disableTimeSec; // @synthesize disableTimeSec=_disableTimeSec;
...
- (id)description;
@property(nonatomic) _Bool hasDeleteTimeSec;
@property(nonatomic) _Bool hasDisableTimeSec;
