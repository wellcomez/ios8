...
@class CKDURLRequest, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>;
...
- (void).cxx_destruct;
- (void)ensureTokenRefreshForAppContainerTuple:(id)arg1 apsEnvironmentString:(id)arg2 useAPSPublicToken:(_Bool)arg3 completionBlock:(id)arg4;
