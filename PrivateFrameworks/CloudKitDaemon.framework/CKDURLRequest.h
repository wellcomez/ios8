...
@interface CKDURLRequest : NSObject <CKDURLSessionTaskDelegate, CKDFlowControlBudgetable, CKDProtobufMessageSigningDelegate, CKDFlowControllable>
{
    ...
    unsigned long long _accumulatedFlowControlCost;
...
@property(nonatomic) unsigned long long accumulatedFlowControlCost; // @synthesize accumulatedFlowControlCost=_accumulatedFlowControlCost;
...
@property(readonly, nonatomic) NSArray *requestOperationClasses; // @synthesize requestOperationClasses=_requestOperationClasses;
...
- (unsigned long long)flowControlCost;
- (id)flowControlKey;
- (id)description;
