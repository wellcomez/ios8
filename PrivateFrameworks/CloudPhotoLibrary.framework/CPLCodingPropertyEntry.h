...
@interface CPLCodingPropertyEntry : NSObject
{
    ...
    SEL _propertyGetter;
    SEL _propertySetter;
    void *_propertyGetterIMP;
    void *_propertySetterIMP;
...
@property(nonatomic) void *propertySetterIMP; // @synthesize propertySetterIMP=_propertySetterIMP;
@property(nonatomic) void *propertyGetterIMP; // @synthesize propertyGetterIMP=_propertyGetterIMP;
