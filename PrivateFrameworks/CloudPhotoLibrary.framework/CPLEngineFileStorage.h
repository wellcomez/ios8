...
- (_Bool)openWithRecoveryHandler:(id)arg1 error:(void)arg2;
- (_Bool)_recoverFromCrashWithRecoveryHandler:(id)arg1 error:(void)arg2;
- (_Bool)doWrite:(id)arg1 error:(void)arg2;
- (void)doRead:(id)arg1;
