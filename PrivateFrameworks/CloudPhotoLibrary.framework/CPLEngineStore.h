...
@class CPLEngineChangePipe, CPLEngineClientCache, CPLEngineCloudCache, CPLEngineIDMapping, CPLEngineLibrary, CPLEngineResourceDownloadQueue, CPLEngineResourceStorage, CPLEngineResourceUploadQueue, CPLEngineTransientRepository, CPLPlatformObject, NSArray, NSHashTable, NSMutableArray, NSObject<OS_dispatch_queue>;
...
- (void)performBatchedWriteTransactionWithBlock:(id)arg1 completionHandler:(void)arg2;
- (void)_reallyPerformBatchedTransactionsLocked;
- (void)_scheduleBatchedTransactionsLocked;
- (id)performWriteTransactionWithBlock:(id)arg1 completionHandler:(void)arg2;
...
- (_Bool)resetCompleteSyncStateWithError:(id *)arg1;
- (_Bool)resetLocalSyncStateWithError:(id *)arg1;
