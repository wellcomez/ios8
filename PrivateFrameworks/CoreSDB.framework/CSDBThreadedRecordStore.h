...
- (void)setupDatabaseWithAllowLocalMigration:(_Bool)arg1 pathBlock:(id)arg2 setupStoreHandler:(void)arg3 connectionInitializer:(void *)arg4 versionChecker:(void *)arg5 migrationHandler:(void *)arg6 schemaVersion:(void *)arg7 classCProtection:(int)arg8 registerBlock:(_Bool)arg9;
- (void)dealloc;
