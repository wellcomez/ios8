...
@class NSData, NSMutableArray, NSMutableIndexSet, NSMutableString;
...
@interface SGHtmlParserDissectorTask : NSObject
{
    ...
    unsigned long long _startOfCurrentQuotedRegion;
    NSMutableIndexSet *_quotedRegions;
}

- (void).cxx_destruct;
- (void)addQuotedRegionFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;
- (void)endBlockquote;
