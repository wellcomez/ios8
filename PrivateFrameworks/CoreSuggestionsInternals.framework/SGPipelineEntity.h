...
+ (id)emailAddress:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(_Bool)arg4 context:(id)arg5 contextRangeOfInterest:(struct _NSRange)arg6;
+ (id)phoneNumber:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(_Bool)arg4 context:(id)arg5 contextRangeOfInterest:(struct _NSRange)arg6;
+ (id)address:(id)arg1 forIdentity:(id)arg2 parent:(id)arg3 curated:(_Bool)arg4 context:(id)arg5 contextRangeOfInterest:(struct _NSRange)arg6;
...
- (void)addDetectedEmailAddress:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(struct _NSRange)arg4;
- (void)addCuratedPhoneNumber:(id)arg1;
- (void)addDetectedPhoneNumber:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(struct _NSRange)arg4;
- (void)addCuratedPostalAddress:(id)arg1;
- (void)addDetectedPostalAddress:(id)arg1 forIdentity:(id)arg2 context:(id)arg3 contextRangeOfInterest:(struct _NSRange)arg4;
...
- (id)initWithContactDetailWithKey:(id)arg1 type:(unsigned long long)arg2 curated:(_Bool)arg3 parent:(id)arg4 value:(id)arg5 context:(id)arg6 contextRangeOfInterest:(struct _NSRange)arg7;
