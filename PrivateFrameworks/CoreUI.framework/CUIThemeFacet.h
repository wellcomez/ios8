...
- (void)_drawMaskFromSpecificRenditionKey:(id)arg1 inFrame:(struct CGRect)arg2 alpha:(double)arg3 operation:(int)arg4 isFocused:(_Bool)arg5 context:(struct CGContext *)arg6;
- (void)drawPulseInFrame:(struct CGRect)arg1 pulseValue:(double)arg2 isFocused:(_Bool)arg3 keyAdjustment:(id)arg4 context:(struct CGContext *)arg5;
- (void)drawMaskInFrame:(struct CGRect)arg1 alpha:(double)arg2 operation:(int)arg3 isFocused:(_Bool)arg4 keyAdjustment:(id)arg5 context:(struct CGContext *)arg6;
- (void)drawMaskInFrame:(struct CGRect)arg1 alpha:(double)arg2 isFocused:(_Bool)arg3 keyAdjustment:(id)arg4 context:(struct CGContext *)arg5;
...
- (void)drawInFrame:(struct CGRect)arg1 alpha:(double)arg2 operation:(int)arg3 isFocused:(_Bool)arg4 keyAdjustment:(id)arg5 context:(struct CGContext *)arg6;
- (void)drawInFrame:(struct CGRect)arg1 alpha:(double)arg2 isFocused:(_Bool)arg3 keyAdjustment:(id)arg4 context:(struct CGContext *)arg5;
...
- (void)drawSegmentInFrame:(struct CGRect)arg1 isFocused:(_Bool)arg2 segmentType:(int)arg3 context:(struct CGContext *)arg4;
...
- (void)drawAsOnePartWithSlice:(int)arg1 inFrame:(struct CGRect)arg2 isFocused:(_Bool)arg3 context:(struct CGContext *)arg4;
...
- (void)drawInFrame:(struct CGRect)arg1 alpha:(double)arg2 isFocused:(_Bool)arg3 context:(struct CGContext *)arg4;
