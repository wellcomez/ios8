...
- (oneway void)getAbRecordIdForHandle:(id)arg1 completion:(id)arg2;
- (oneway void)getPrettyNameForHandle:(id)arg1 completion:(id)arg2;
...
- (oneway void)setHideMyLocationEnabled:(_Bool)arg1 completion:(id)arg2;
