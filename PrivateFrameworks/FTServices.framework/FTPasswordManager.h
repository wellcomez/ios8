...
- (void)fetchPasswordForUsername:(id)arg1 service:(id)arg2 outRequestID:(id *)arg3 blockingly:(_Bool)arg4 completionBlock:(id)arg5;
- (void)fetchAuthTokenForUsername:(id)arg1 service:(id)arg2 outRequestID:(id *)arg3 blockingly:(_Bool)arg4 completionBlock:(id)arg5;
- (void)dealloc;
- (id)init;
