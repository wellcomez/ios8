...
+ (void)loadTurnBasedMatchDetailsForMatchIDs:(id)arg1 loadGameData:(_Bool)arg2 withCompletionHandler:(id)arg3;
+ (void)loadTurnBasedMatchSummariesIncludingCompatibleBundleID:(_Bool)arg1 withCompletionHandler:(id)arg2;
+ (void)loadTurnBasedMatchSummaries:(id)arg1;
+ (void)loadMatchesIncludingCompatibleBundleID:(_Bool)arg1 withCompletionHandler:(id)arg2;
