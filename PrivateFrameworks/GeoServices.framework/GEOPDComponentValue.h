...
@class GEOPDAddress, GEOPDAmenities, GEOPDBounds, GEOPDETA, GEOPDEntity, GEOPDFlyover, GEOPDHours, GEOPDPhoto, GEOPDPlaceInfo, GEOPDRating, GEOPDRawAttribute, GEOPDReview, GEOPDRoadAccessInfo;
