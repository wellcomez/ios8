...
@property(retain, nonatomic) NSString *eventDisplayName;
@property(readonly, nonatomic) _Bool hasEventDisplayName;
@property(retain, nonatomic) NSString *contactSpokenName;
@property(readonly, nonatomic) _Bool hasContactSpokenName;
...
@property(nonatomic) _Bool hasWaypointLabelType;
