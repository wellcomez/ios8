...
@property(retain, nonatomic) NSString *transactionHarvestURL; // @synthesize transactionHarvestURL=_transactionHarvestURL;
...
@property(readonly, nonatomic) _Bool hasTransactionHarvestURL;
