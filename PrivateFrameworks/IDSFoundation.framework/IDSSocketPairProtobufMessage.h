...
- (void)dealloc;
- (id)initWithSequenceNumber:(unsigned int)arg1 streamID:(unsigned short)arg2 expectsPeerResponse:(_Bool)arg3 peerResponseIdentifier:(id)arg4 messageUUID:(id)arg5 protobuf:(id)arg6;
