...
- (void)didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(_Bool)arg5 date:(id)arg6 completionBlock:(id)arg7;
- (void)_didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(_Bool)arg5 date:(id)arg6 attempts:(long long)arg7 completionBlock:(id)arg8;
...
- (void)_didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 completionBlock:(id)arg4;
...
- (_Bool)sendLocationSharingInfo:(id)arg1 toID:(id)arg2;
- (void)leaveAllChats;
