...
@class IKDOMDocument, ISURLOperation, NSDictionary, NSHTTPURLResponse, NSMutableArray, NSMutableData, NSMutableURLRequest, NSString, NSURLConnection;
...
- (void)_immediateUpdateReadyState:(unsigned int)arg1 statusCode:(unsigned int)arg2 statusText:(id)arg3 shouldCall:(_Bool)arg4;
