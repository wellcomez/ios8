...
#import "MPUMiniPlayerActionsViewControllerDelegate-Protocol.h"
#import "UIPopoverControllerDelegate-Protocol.h"

@class MPUMiniPlayerActionsViewController, MPUMiniPlayerTransportControls, MPUNowPlayingTitlesView, MPUProspectivePlaybackInformation, MPUSkipLimitView, MPVolumeSlider, SKUICircleProgressIndicator, UIButton, UIPopoverController, UIView;
...
@property(readonly, nonatomic) double centerClusterMaxX;
