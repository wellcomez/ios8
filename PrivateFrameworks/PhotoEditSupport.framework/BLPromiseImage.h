...
- (id)flattenedImageInBoundingSize:(struct CGSize)arg1 shouldScaleForScreen:(_Bool)arg2 progressBlock:(id)arg3;
- (_Bool)_flattenInContext:(struct CGContext *)arg1 targetSize:(struct CGSize)arg2 progressBlock:(id)arg3;
