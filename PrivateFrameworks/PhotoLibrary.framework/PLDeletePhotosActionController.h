...
- (void)showInView:(id)arg1 willDeleteHandler:(id)arg2 completionHandler:(void)arg3;
- (void)showFromObject:(id)arg1 animated:(_Bool)arg2 willDeleteHandler:(id)arg3 completionHandler:(void)arg4;
