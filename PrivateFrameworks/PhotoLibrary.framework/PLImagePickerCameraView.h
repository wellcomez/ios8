...
@class CAMStillImageCaptureResponse, NSDictionary, PLCropOverlay, PLPhotoTileViewController, PLVideoView, UIView;

@interface PLImagePickerCameraView : CAMCameraView <PLVideoViewDelegate>
{
    _Bool _allowsEditing;
    _Bool _allowsStillDuringVideo;
...
@property(nonatomic) _Bool allowsStillDuringVideo; // @synthesize allowsStillDuringVideo=_allowsStillDuringVideo;
