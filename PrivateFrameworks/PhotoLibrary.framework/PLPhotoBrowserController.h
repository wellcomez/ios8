...
#import "PLPhotoScrubberSpeedDelegate-Protocol.h"
...
- (unsigned long long)allowedDeleteOperationForAsset:(id)arg1;
...
- (void)_shuffleAssets:(_Bool)arg1 startingAsset:(id)arg2;
