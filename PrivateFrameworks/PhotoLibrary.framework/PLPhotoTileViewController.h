...
@class NSObject<OS_dispatch_source>, PHAsset, PHCachingImageManager, PLCommentsViewController, PLExpandableImageView, PLImageScrollView, PLPhotoTileBadgeView, PLTileContainerView, PLVideoView, UIGestureRecognizer, UIImage, UIImageView, UIView<PLTilePlaceholderView>;
...
@interface PLPhotoTileViewController : UIViewController <UIScrollViewDelegate, UIGestureRecognizerDelegate, PLCommentsViewControllerDelegate, PLPhotoTileCloudPlaceholderViewDelegate>
{
    ...
    unsigned long long _fullSizeImageRequestID;
...
- (void)zoomToScale:(double)arg1 animated:(_Bool)arg2 completionBlock:(id)arg3;
