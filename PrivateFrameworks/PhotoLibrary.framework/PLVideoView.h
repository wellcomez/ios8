...
@class AVAssetExportSession, NSArray, NSDictionary, NSLock, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, NSTimer, NSURL, PFVideoAVObjectBuilder, PLManagedAsset, PLMoviePlayerController, PLPhotoBakedThumbnails, PLPhotoTileViewController, PLProgressStack, PLSlalomRegionEditor, PLVideoEditingOverlayView, PLVideoPosterFrameView, UIActivityIndicatorView, UIImage, UIImageView, UIMovieScrubber, UIView<PLVideoOverlayButton>;
...
@property(readonly, nonatomic) _Bool _localVideoUnavailable; // @synthesize _localVideoUnavailable=__localVideoUnavailable;
...
- (void)_commitUpdatedAdjustmentsAndWait:(_Bool)arg1;
