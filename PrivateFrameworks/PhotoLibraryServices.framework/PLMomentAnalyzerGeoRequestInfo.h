...
@class GEOBatchRevGeocodeRequest, NSArray, NSObject<NSCopying>, NSString, PLRevGeoLocationInfo;
...
@interface PLMomentAnalyzerGeoRequestInfo : NSObject
{
    ...
    NSArray *_assetIds;
    struct GEOBatchRevGeocodeRequest *_reverseGeocodeRequest;
...
@property(retain, nonatomic) GEOBatchRevGeocodeRequest *reverseGeocodeRequest; // @synthesize reverseGeocodeRequest=_reverseGeocodeRequest;
...
- (void)dealloc;
- (id)initWithRequestType:(unsigned long long)arg1 momentId:(id)arg2 momentUuid:(id)arg3 assetIds:(id)arg4 reverseGeocodeRequest:(struct GEOBatchRevGeocodeRequest *)arg5;
