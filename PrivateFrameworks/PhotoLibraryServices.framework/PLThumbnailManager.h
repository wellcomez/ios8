...
- (id)newImageDataForPhoto:(id)arg1 withFormat:(int)arg2 wantURLOnly:(_Bool)arg3 networkAccessAllowed:(_Bool)arg4 networkAccessForced:(_Bool)arg5 trackCPLDownload:(_Bool)arg6 outImageDataInfo:(id *)arg7 outCPLDownloadContext:(id *)arg8;
- (id)newImageForPhoto:(id)arg1 withFormat:(int)arg2 allowPlaceholder:(_Bool)arg3 outImageProperties:(const struct __CFDictionary **)arg4;
