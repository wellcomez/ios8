...
@property(copy, nonatomic) id entryComparator; // @synthesize entryComparator=_entryComparator;
@property(copy, nonatomic) id sectionComparator; // @synthesize sectionComparator=_sectionComparator;
- (id)description;
- (void)dealloc;
