...
#import "RUHistoryDataSourceDelegate-Protocol.h"
...
@class MPAVItem, MPMoviePlayerController, NSArray, NSMutableArray, RUHistoryDataSource, RUPreviewSession, RURadioAdTrack, RUWishlistDataSource, RadioHistoryCategory, SKUICircleProgressIndicator, UIActionSheet, UILabel, UITableView;
