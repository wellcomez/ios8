...
#import "RUMiniPlayerRadioTransportControlsTarget-Protocol.h"
...
@class RURadioPlaybackCoordinator, RUStationActionsViewController, RUTrackActionsModalItem, RUTrackActionsViewController, RadioStation, UIPopoverPresentationController;
