...
@class NSMutableIndexSet, SKUIMenuPageComponent, SKUIMenuViewController, SKUIPillsControl, SKUIPopupMenuHeaderView, UIBarButtonItem, UIPopoverController;
...
@property(retain, nonatomic) SKUIMenuPageComponent *pageComponent; // @dynamic pageComponent;
