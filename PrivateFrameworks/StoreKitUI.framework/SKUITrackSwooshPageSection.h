...
#import "SKUITrackSwooshViewControllerDelegate-Protocol.h"

@class SKUIMissingItemLoader, SKUISwooshPageComponent, SKUITrackSwooshArtworkLoader, SKUITrackSwooshViewController;
