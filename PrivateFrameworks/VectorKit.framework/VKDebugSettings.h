...
@interface VKDebugSettings : NSObject
{
    ...
    _Bool _labelAlternatePositionsEnabled;
...
@property(nonatomic) _Bool labelAlternatePositionsEnabled; // @synthesize labelAlternatePositionsEnabled=_labelAlternatePositionsEnabled;
