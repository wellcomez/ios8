...
@interface VKRealisticTile : VKVectorTile
{
    ...
    fast_shared_ptr_2ab6109a _defaultLandTexture;
    fast_shared_ptr_2ab6109a _defaultLandTextureVariant;
...
@property(readonly, nonatomic) fast_shared_ptr_2ab6109a defaultLandTexture; // @synthesize defaultLandTexture=_defaultLandTexture;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (fast_shared_ptr_2ab6109a)_createDefaultTextureForLevelOfDetail:(unsigned long long)arg1 takeVariant:(_Bool)arg2;
...
@property(readonly, nonatomic) fast_shared_ptr_2ab6109a defaultLandTextureVariant;
- (void)_parsePolygons;
- (void)updateTextures;
- (void)createMeshes;
- (void)dealloc;
