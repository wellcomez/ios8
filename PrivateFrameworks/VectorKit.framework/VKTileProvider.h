...
@class GEOTileKeyList, NSArray, NSLocale, NSMutableSet, NSSet, VKMapRasterizer, VKStyleManager, VKTileCache, VKTileKeyList, VKTileSelection, VKTileSource, VKTimer, _VKTileProviderTimerTarget;
