...
#import "RCGLWaveformViewDelegate-Protocol.h"
#import "RCPreviewControllerObserver-Protocol.h"

@class RCAVState, RCCaptureSession, RCCompositionController, RCGLWaveformViewController, RCLayoutMetrics, RCPreviewController, RCUIConfiguration, RCWaveformDataSource;
