...
@class NSMutableArray, NSTimer, RCAcousticAnnotationView, RCGLWaveformRenderer, RCLayoutMetrics, RCUIConfiguration, RCWaveformDataSource, RCWaveformScrollView, RCWaveformSelectionOverlay, UIView;
...
- (void)_setVisibleTimeRange:(CDStruct_73a5d3ca)arg1 animationDuration:(double)arg2 completionBlock:(id)arg3;
