...
#import "RCAVPlayerDelegate-Protocol.h"

@class AVPlayerItem, NSHashTable, NSMutableDictionary, NSUUID, RCAVPlayer, RCAVState, RCAudioSessionRoutingAssertion;
...
- (_Bool)_monitorUnderlyingAssetPathInPlayerItem:(id)arg1 assetDisappearedBlock:(id)arg2;
