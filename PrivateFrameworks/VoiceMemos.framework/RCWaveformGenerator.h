...
- (void)_finishLoadingByTerminating:(_Bool)arg1 loadingFinishedBlockTimeoutDate:(id)arg2 loadingFinishedBlock:(id)arg3;
- (_Bool)_isCanceled;
...
- (_Bool)appendAveragePowerLevelsByDigestingContentsOfAudioFileURL:(id)arg1 progressBlock:(id)arg2;
