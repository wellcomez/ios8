...
@class NSArray, NSDictionary, NSMutableArray, NSTimer, UIView, UIViewController, UIWebClip, UIWebView, UIWindow, WBUSheetController, WebUIAuthenticationManager, WebUIDownloadManager;
