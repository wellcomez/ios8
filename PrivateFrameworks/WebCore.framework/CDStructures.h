...
struct AudioSession {
    struct unique_ptr<WebCore::AudioSessionPrivate, std::__1::default_delete<WebCore::AudioSessionPrivate>> _field1;
...
struct HTMLMediaElement {
    ...
    struct RefPtr<WebCore::TimeRanges> _field30;
    struct GenericEventQueue _field31;
    double _field32;
    double _field33;
    _Bool _field34;
    int _field35;
    ...
    int _field37;
    struct URL _field38;
    struct RefPtr<WebCore::MediaError> _field39;
    double _field40;
    _Bool _field41;
    double _field42;
    ...
    double _field46;
    int _field47;
    struct RefPtr<WebCore::HTMLSourceElement> _field48;
    struct RefPtr<WebCore::Node> _field49;
    struct RetainPtr<CALayer> _field50;
    struct FloatRect _field51;
    int _field52;
    struct OwnPtr<WebCore::MediaPlayer> _field53;
    int _field54;
    int _field55;
    int _field56;
    double _field57;
    ...
    unsigned int :1;
    unsigned int :1;
    struct String _field66;
    float _field67;
    int _field68;
    struct RefPtr<WebCore::AudioTrackList> _field69;
    struct RefPtr<WebCore::TextTrackList> _field70;
    struct RefPtr<WebCore::VideoTrackList> _field71;
    struct Vector<WTF::RefPtr<WebCore::TextTrack>, 0, WTF::CrashOnOverflow> _field72;
    struct PODIntervalTree<double, WebCore::TextTrackCue *> _field73;
    struct Vector<WebCore::PODInterval<double, WebCore::TextTrackCue *>, 0, WTF::CrashOnOverflow> _field74;
    int _field75;
    struct MediaElementAudioSourceNode *_field76;
    struct String _field77;
    struct RefPtr<WebCore::MediaController> _field78;
    struct unique_ptr<WebCore::DisplaySleepDisabler, std::__1::default_delete<WebCore::DisplaySleepDisabler>> _field79;
    struct RefPtr<WebCore::PlatformTextTrackMenuInterface> _field80;
    struct unique_ptr<WebCore::HTMLMediaSession, std::__1::default_delete<WebCore::HTMLMediaSession>> _field81;
    struct unique_ptr<WebCore::PageActivityAssertionToken, std::__1::default_delete<WebCore::PageActivityAssertionToken>> _field82;
    unsigned long long _field83;
    struct RefPtr<WebCore::MediaControlsHost> _field84;
    struct RefPtr<WebCore::DOMWrapperWorld> _field85;
};
...
struct MediaPlayerPrivateAVFoundationObjC {
    ...
    _Bool _field51;
    _Bool _field52;
    struct RetainPtr<AVAssetImageGenerator> _field53;
    struct RetainPtr<AVPlayerItemVideoOutput> _field54;
    struct RetainPtr<WebCoreAVFPullDelegate> _field55;
    struct RetainPtr<CGImage *> _field56;
    id _field57;
    struct HashMap<WTF::RetainPtr<AVAssetResourceLoadingRequest>, WTF::RefPtr<WebCore::WebCoreAVFResourceLoader>, WTF::PtrHash<WTF::RetainPtr<AVAssetResourceLoadingRequest>>, WTF::HashTraits<WTF::RetainPtr<AVAssetResourceLoadingRequest>>, WTF::HashTraits<WTF::RefPtr<WebCore::WebCoreAVFResourceLoader>>> _field58;
    struct RetainPtr<WebCoreAVFLoaderDelegate> _field59;
    struct HashMap<WTF::String, WTF::RetainPtr<AVAssetResourceLoadingRequest>, WTF::StringHash, WTF::HashTraits<WTF::String>, WTF::HashTraits<WTF::RetainPtr<AVAssetResourceLoadingRequest>>> _field60;
    ...
    struct RetainPtr<AVPlayerItemLegibleOutput> _field62;
    struct Vector<WTF::RefPtr<WebCore::AudioTrackPrivateAVFObjC>, 0, WTF::CrashOnOverflow> _field63;
    struct Vector<WTF::RefPtr<WebCore::VideoTrackPrivateAVFObjC>, 0, WTF::CrashOnOverflow> _field64;
    struct InbandTextTrackPrivateAVF *_field65;
    struct RefPtr<WebCore::InbandMetadataTextTrackPrivateAVF> _field66;
    struct RetainPtr<NSArray> _field67;
    struct RetainPtr<NSArray> _field68;
    struct RetainPtr<NSArray> _field69;
    struct RetainPtr<NSArray> _field70;
    struct FloatSize _field71;
    double _field72;
    double _field73;
    long long _field74;
...
struct MediaSessionManageriOS {
    ...
    struct Vector<WebCore::MediaSession *, 0, WTF::CrashOnOverflow> _field4;
    struct Vector<WebCore::MediaSessionManagerClient *, 0, WTF::CrashOnOverflow> _field5;
    ...
    _Bool _field8;
    struct RetainPtr<WebMediaSessionHelper> _field9;
};
...
struct WebVideoFullscreenControllerChangeObserver {
    void **_vptr$WebVideoFullscreenChangeObserver;
