...
struct DocumentLoader {
    ...
    struct RefPtr<WebCore::ContentFilter> _field49;
...
struct HistoryItem {
    ...
    float _field24;
    _Bool _field25;
    struct ViewportArguments _field26;
    unsigned int _field27;
    struct String _field28;
    struct RetainPtr<id> _field29;
    struct unique_ptr<WTF::HashMap<WTF::String, WTF::RetainPtr<id>, WTF::StringHash, WTF::HashTraits<WTF::String>, WTF::HashTraits<WTF::RetainPtr<id>>>, std::__1::default_delete<WTF::HashMap<WTF::String, WTF::RetainPtr<id>, WTF::StringHash, WTF::HashTraits<WTF::String>, WTF::HashTraits<WTF::RetainPtr<id>>>>> _field30;
};
...
struct InspectorController {
    ...
    struct RefPtr<Inspector::InspectorBackendDispatcher> _field12;
    struct unique_ptr<WebCore::InspectorFrontendClient, std::__1::default_delete<WebCore::InspectorFrontendClient>> _field13;
    struct InspectorFrontendChannel *_field14;
    struct Page *_field15;
    struct InspectorClient *_field16;
    struct InspectorAgentRegistry _field17;
    struct Vector<WebCore::InspectorInstrumentationCookie, 2, WTF::CrashOnOverflow> _field18;
    _Bool _field19;
    _Bool _field20;
};
