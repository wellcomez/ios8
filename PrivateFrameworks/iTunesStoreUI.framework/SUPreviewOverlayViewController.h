...
- (void)showInViewController:(id)arg1 animated:(_Bool)arg2 completionBlock:(id)arg3;
...
- (void)hideInViewController:(id)arg1 animated:(_Bool)arg2 completionBlock:(id)arg3;
