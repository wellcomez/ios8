...
struct CommandApplyFillSetArchive_CapturedFillSetArchive {
    void **_field1;
    struct UnknownFieldSet _field2;
    basic_string_a1f69cfb *_field3;
    struct RepeatedPtrField<TSCH::ChartSeriesStyleArchive> _field4;
    unsigned int _field5;
    int _field6;
    unsigned int _field7[1];
};
...
struct RepeatedPtrField<TSCH::ChartSeriesStyleArchive> {
    void **_field1;
    int _field2;
    int _field3;
    int _field4;
...
struct RepeatedPtrField<TST::TableBackedCellMapArchive_CellIDEntry> {
    void **_field1;
    int _field2;
    int _field3;
    int _field4;
...
struct TableBackedCellMapArchive {
    void **_field1;
    struct UnknownFieldSet _field2;
    struct Reference *_field3;
    unsigned int _field4;
    unsigned int _field5;
    struct RepeatedPtrField<TST::TableBackedCellMapArchive_CellIDEntry> _field6;
    _Bool _field7;
    _Bool _field8;
    _Bool _field9;
    int _field10;
