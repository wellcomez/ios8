...
@class KNBodyPlaceholderInfo, KNObjectPlaceholderInfo, KNSlideBackgroundInfo, KNSlideNode, KNSlideNumberPlaceholderInfo, KNSlideStyle, KNTitlePlaceholderInfo, KNTransition, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<TSDContainerInfo>, TSDFill, TSDGuideStorage, TSDInfoGeometry, TSPObject<TSDOwningAttachment>, TSUMutablePointerSet, TSUPointerKeyDictionary;
