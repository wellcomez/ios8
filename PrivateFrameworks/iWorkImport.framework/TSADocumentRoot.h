...
@class NSArray, NSMutableDictionary, NSMutableSet, NSSet, NSString, TSAFunctionBrowserState, TSAShortcutController, TSCECalculationEngine, TSKViewState, TSTCustomFormatList;
