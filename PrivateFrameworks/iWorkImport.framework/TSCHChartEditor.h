...
@interface TSCHChartEditor : TSDDrawableEditor <TSDStylePresetsInspectorPaneDelegate>
{
    ...
    _Bool mShouldUpdateCurrentTabBasedOnSubselection;
...
@property(nonatomic) _Bool shouldUpdateCurrentTabBasedOnSubselection; // @synthesize shouldUpdateCurrentTabBasedOnSubselection=mShouldUpdateCurrentTabBasedOnSubselection;
...
- (void)setShowLabelsInFront:(_Bool)arg1;
...
- (void)setChartLabelPosition:(long long)arg1 useSelection:(_Bool)arg2 updateShowProperty:(_Bool)arg3;
