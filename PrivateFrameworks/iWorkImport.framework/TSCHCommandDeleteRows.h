...
- (_Bool)process;
- (void)dealloc;
- (id)initWithChartInfo:(id)arg1 rowRange:(struct _NSRange)arg2 addDummyDataOnDeleteAll:(_Bool)arg3 newRowIds:(id)arg4 newColumnIds:(id)arg5;
- (id)initWithChartInfo:(id)arg1 rowRange:(struct _NSRange)arg2 newRowIds:(id)arg3 newColumnIds:(id)arg4;
