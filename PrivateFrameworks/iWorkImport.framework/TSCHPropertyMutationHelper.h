...
+ (id)commandWithMutationTuples:(id)arg1 allowSpecificProperties:(_Bool)arg2;
...
+ (id)commandWithStyleOwner:(id)arg1 mutationsMap:(id)arg2 allowSpecificProperties:(_Bool)arg3;
+ (id)commandWithStyleOwner:(id)arg1 mutations:(id)arg2 allowSpecificProperties:(_Bool)arg3;
- (id)init;
