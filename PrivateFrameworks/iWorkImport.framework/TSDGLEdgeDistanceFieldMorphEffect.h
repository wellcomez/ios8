...
- (void)teardown;
- (void)dealloc;
- (id)initWithOutgoingTextureName:(unsigned int)arg1 outgoingTextureSize:(struct CGSize)arg2 outgoingTextBounds:(struct CGRect)arg3 outgoingColor:(CDStruct_f2e236b6)arg4 incomingTextureName:(unsigned int)arg5 incomingTextureSize:(struct CGSize)arg6 incomingTextBounds:(struct CGRect)arg7 incomingColor:(CDStruct_f2e236b6)arg8 motionBlur:(_Bool)arg9 motionBlurIgnoreTextureOpacity:(_Bool)arg10;
- (id)initWithOutgoingTR:(id)arg1 incomingTR:(id)arg2 motionBlur:(_Bool)arg3 motionBlurIgnoreTextureOpacity:(_Bool)arg4;
