...
- (void)calculateTextureClipBounds:(struct CGRect *)arg1 andOffset:(struct CGPoint *)arg2 withTransform:(struct CGAffineTransform *)arg3 textureContext:(id)arg4 isUsingImageTexture:(_Bool)arg5;
