...
@class NSMapTable, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSURL, NSUUID, TSPDatabase, TSPDocumentResourceDataProvider, TSPFinalizeHandlerQueue, TSPObjectContext;
