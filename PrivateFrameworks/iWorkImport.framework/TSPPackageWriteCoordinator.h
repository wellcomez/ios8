...
@class NSHashTable, NSMutableArray, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSURL, TSPArchiverManager, TSPComponentExternalReferenceMap, TSPDocumentRevision, TSPObjectContainer, TSPObjectContext, TSPPackageMetadata, TSUPathSet;
...
- (void)dealloc;
- (id)initWithContext:(id)arg1 documentRevision:(id)arg2 saveToken:(unsigned long long)arg3 packageIdentifier:(unsigned char)arg4 fileFormatVersion:(unsigned long long)arg5 packageWriteCoordinator:(id)arg6 captureSnapshots:(_Bool)arg7;
