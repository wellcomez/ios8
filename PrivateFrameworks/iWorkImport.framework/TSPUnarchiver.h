...
- (void)readRepeatedLazyReferenceMessage:(const RepeatedPtrField_a0d2dbe7 *)arg1 isWeak:(_Bool)arg2 shouldValidate:(_Bool)arg3 allowUnknownObject:(_Bool)arg4 completion:(id)arg5;
...
- (void)readLazyReferenceMessage:(const struct Reference *)arg1 isWeak:(_Bool)arg2 shouldValidate:(_Bool)arg3 allowUnknownObject:(_Bool)arg4 completion:(id)arg5;
...
- (void)readReferenceMessage:(const struct Reference *)arg1 isWeak:(_Bool)arg2 shouldValidate:(_Bool)arg3 allowUnknownObject:(_Bool)arg4 completion:(id)arg5;
