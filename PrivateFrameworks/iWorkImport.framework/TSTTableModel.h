...
@class NSArray, NSString, TSCECalculationEngine, TSCECellCoordinateVector, TSCEOwnerFormulaMap, TSDFill, TSDStroke, TSKDocumentRoot, TSTCell, TSTCellDictionary, TSTCellStyle, TSTConditionalStyleFormulaOwner, TSTHiddenStateFormulaOwner, TSTSortRuleReferenceTracker, TSTTableDataStore, TSTTableFilterSet, TSTTableSortOrder, TSTTableStyle, TSWPParagraphStyle, TSWPShapeStyle, TSWPStorage;
